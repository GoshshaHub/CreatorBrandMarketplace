...
export async function POST(req: Request) {
  try {
    ...
    await adminDb.collection("notifications").add({
      ...
      title: "New IRL Campaign Preview Needs AR Creation",
      message: `${finalBrandName} created a first IRL campaign preview and needs scan-ready AR created: ${finalCampaignTitle}`,
      campaignId,
      isRead: false,
      createdAt: FieldValue.serverTimestamp(),
      updatedAt: FieldValue.serverTimestamp(),
